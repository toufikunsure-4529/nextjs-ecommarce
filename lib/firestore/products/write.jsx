...
//addd new product form submit firebase methods
export const createNewProduct = async ({ data, featureImage, imageList }) => {
  ...
  //for feature image upload and get ref
  ...
  let imageURLList = []; //store image url all images

  //loop thorough imageList and get url for each image
  ...
  const newId = doc(collection(db, `ids`)).id; //generate new Id for set product id

  //products data set on the docs with image url
